...
// This fork's GA4 tag is delivered through the GTM container configured in
// src/lib/analytics.config.ts, so these direct-loader IDs stay on their env
// placeholders (isConfigured keeps the loaders inert) — wiring the real GA4
// ID here as well would double-fire the tag alongside GTM.
